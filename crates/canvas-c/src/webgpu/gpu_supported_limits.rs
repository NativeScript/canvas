...
impl Into<wgt::Limits> for CanvasGPUSupportedLimits {
    fn into(self) -> wgt::Limits {
        wgt::Limits {
            ...
            max_task_mesh_workgroup_total_count: self.max_task_mesh_workgroup_total_count,
            max_task_mesh_workgroups_per_dimension: self.max_task_mesh_workgroups_per_dimension,
...
impl From<wgt::Limits> for CanvasGPUSupportedLimits {
    fn from(value: wgt::Limits) -> Self {
        CanvasGPUSupportedLimits {
            ...
            max_task_mesh_workgroup_total_count: value.max_task_mesh_workgroup_total_count,
            max_task_mesh_workgroups_per_dimension: value.max_task_mesh_workgroups_per_dimension,
