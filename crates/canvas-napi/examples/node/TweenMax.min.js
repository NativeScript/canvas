					...
					if (
						(a >= n - 1e-7
							...
							: ((this._totalTime = this._time = a),
							  0 !== this._repeat && ((i = r + this._repeatDelay), (this._cycle = (this._totalTime / i) >> 0), 0 !== this._cycle && this._cycle === this._totalTime / i && a >= p && this._cycle--, (this._time = this._totalTime - this._cycle * i), this._yoyo && 0 !== (1 & this._cycle) && (this._time = r - this._time), this._time > r ? (this._time = r) : this._time < 0 && (this._time = 0)),
						...
						if (a)
							if ('number' == typeof a) c = [a >> 16, (a >> 8) & 255, 255 & a];
								...
								if ((',' === a.charAt(a.length - 1) && (a = a.substr(0, a.length - 1)), ka[a])) c = ka[a];
									...
									} else (g = (Number(c[0]) % 360) / 360), (h = Number(c[1]) / 100), (i = Number(c[2]) / 100), (e = 0.5 >= i ? i * (h + 1) : i + h - i * h), (d = 2 * i - e), c.length > 3 && (c[3] = Number(a[3])), (c[0] = la(g + 1 / 3, d, e)), (c[1] = la(g, d, e)), (c[2] = la(g - 1 / 3, d, e));
				...
				var za,
					...
					Oa = function (a, b) {
						var c,
							...
							k = a.style;
						if (
							(Ba ? (d = $(a, Ca, null, !0)) : a.currentStyle && ((d = a.currentStyle.filter.match(G)), (d = d && 4 === d.length ? [d[0].substr(4), Number(d[2].substr(4)), Number(d[1].substr(4)), d[3].substr(4), i.x || 0, i.y || 0].join(',') : '')),
							(c = !d || 'none' === d || 'matrix(1, 0, 0, 1, 0, 0)' === d),
							c && Ba && ((h = 'none' === Z(a).display) || !a.parentNode) && (h && ((f = k.display), (k.display = 'block')), a.parentNode || ((g = 1), Ia.appendChild(a)), (d = $(a, Ca, null, !0)), (c = !d || 'none' === d || 'matrix(1, 0, 0, 1, 0, 0)' === d), f ? (k.display = f) : h && Ta(k, 'display'), g && Ia.removeChild(a)),
							(i.svg || (a.getBBox && Ma(a))) && (c && -1 !== (k[Ba] + '').indexOf('matrix') && ((d = k[Ba]), (c = 0)), (e = a.getAttribute('transform')), c && e && (-1 !== e.indexOf('matrix') ? ((d = e), (c = 0)) : -1 !== e.indexOf('translate') && ((d = 'matrix(1,0,0,1,' + e.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(',') + ')'), (c = 0)))),
							c)
						)
							return Na;
								...
								if (((((1 === a || 0 === a) && 'auto' === N && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime)) || !N) && !J && !M && !D && !C && 1 === G) || (za && L) || !Ea)
									return void (B || z.skewX || L
										? ((B *= K),
										  ...
										  L && ((H += z.xOrigin - (z.xOrigin * b + z.yOrigin * c) + z.xOffset), (I += z.yOrigin - (z.xOrigin * e + z.yOrigin * f) + z.yOffset), za && (z.xPercent || z.yPercent) && ((p = this.t.getBBox()), (H += 0.01 * z.xPercent * p.width), (I += 0.01 * z.yPercent * p.height)), (p = 1e-6), p > H && H > -p && (H = 0), p > I && I > -p && (I = 0)),
						...
						parser: function (a, b, c, d, f, h, i) {
							...
							if (((d._transform = C), D && 'string' == typeof D && Ba))
								(l = P.style),
									...
									(k = Pa(P, null, !1)),
									C.svg && ((p = C.xOrigin), (s = C.yOrigin), (k.x -= C.xOffset), (k.y -= C.yOffset), (z.transformOrigin || z.svgOrigin) && ((D = {}), Ka(a, ga(z.transformOrigin), D, z.svgOrigin, z.smoothOrigin, !0), (p = D.xOrigin), (s = D.yOrigin), (k.x -= D.xOffset - C.xOffset), (k.y -= D.yOffset - C.yOffset)), (p || s) && ((t = Oa(P, !0)), (k.x -= p - (p * t[0] + s * t[2])), (k.y -= s - (p * t[1] + s * t[3])))),
									...
									: ((m = $(a, g, e) + ''),
									  ...
									  'color' === g || 'fill' === g || 'stroke' === g || -1 !== g.indexOf('Color') || (s && A.test(n))
											...
											: ((j = parseFloat(m)),
											  ...
											  o !== p && '' !== p && (l || 0 === l) && j && ((j = _(a, g, j, o)), '%' === p ? ((j /= _(a, g, 100, '%') / 100), b.strictUnits !== !0 && (m = j + '%')) : 'em' === p || 'rem' === p || 'vw' === p || 'vh' === p ? (j /= _(a, g, 1, p)) : 'px' !== p && ((l = _(a, g, l, p)), (p = 'px')), t && (l || 0 === l) && (n = l + j + p)),
											  t && (l += j),
											  (!j && 0 !== j) || (!l && 0 !== l) ? (void 0 !== u[g] && (n || (n + '' != 'NaN' && null != n)) ? ((c = new sa(u, g, l || j || 0, 0, c, -1, g, !1, 0, m, n)), (c.xs0 = 'none' !== n || ('display' !== g && -1 === g.indexOf('Style')) ? n : m)) : V('invalid ' + g + ' tween value: ' + b[g])) : ((c = new sa(u, g, j, l - j, c, 0, g, k !== !1 && ('px' === p || 'zIndex' === g), 0, m, n)), (c.xs0 = p)))),
				...
				(g.render = function (a, b, c) {
					...
					if (a >= i - 1e-7) (this._totalTime = this._time = i), (this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || ((d = !0), (e = 'onComplete'), (c = c || this._timeline.autoRemoveChildren)), 0 === i && (this._initted || !this.vars.lazy || c) && (this._startTime === this._timeline._duration && (a = 0), (0 > j || (0 >= a && a >= -1e-7) || (j === l && 'isPause' !== this.data)) && j !== a && ((c = !0), j > l && (e = 'onReverseComplete')), (this._rawPrevTime = g = !b || a || j === a ? a : l));
						...
						var k = a / i,
							m = this._easeType,
							n = this._easePower;
						(1 === m || (3 === m && k >= 0.5)) && (k = 1 - k), 3 === m && (k *= 2), 1 === n ? (k *= k) : 2 === n ? (k *= k * k) : 3 === n ? (k *= k * k * k) : 4 === n && (k *= k * k * k * k), 1 === m ? (this.ratio = 1 - k) : 2 === m ? (this.ratio = k) : 0.5 > a / i ? (this.ratio = k / 2) : (this.ratio = 1 - k / 2);
