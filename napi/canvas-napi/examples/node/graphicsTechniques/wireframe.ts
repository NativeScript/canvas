...
const { GPUBufferUsage, GPUCanvasContext, GPUDevice, GPUTexture, GPUTextureUsage, ImageAsset, GPUBuffer, GPUShaderStage, GPUBindGroup } = require('../../../canvas-napi.darwin-arm64.node');
...
export async function run(canvas) {
	...
	const solidColorLitWGSL = readTextSync('./shaders/solidColorLit.wgsl');

	const wireframeWGSL = readTextSync('./shaders/wireframe.wgsl');
