...
export const enum GPUMipmapFilterMode {
	nearest = 'nearest',
	linear = 'linear',
}
export const enum GPUFilterMode {
	nearest = 'nearest',
	linear = 'linear',
}
...
export interface GPUImageCopyTextureTagged {
	...
	colorSpace?: PredefinedColorSpaceEnum;
	mipLevel?: number;
	origin?: Array<number> | GPUOrigin3DDict;
	premultipliedAlpha?: boolean;
	texture: g_p_u_texture;
}
...
export interface GPUBindGroupSampleEntry {
	binding: number;
	resource: g_p_u_sampler;
}
export interface GPUBindGroupTextureViewEntry {
	binding: number;
	resource: g_p_u_texture_view;
}
export interface GPUBindGroupBufferEntry {
	binding: number;
...
export interface GPURenderPassColorAttachment {
	...
	depthSlice?: number;
	loadOp: GPULoadOp;
	resolveTarget?: g_p_u_texture_view;
	storeOp: GPUStoreOp;
	view: g_p_u_texture_view;
}
...
export interface GpuRenderPassDescriptor {
	...
	label?: string;
	maxDrawCount?: number;
	occlusionQuerySet?: g_p_u_query_set;
...
export interface GpuRenderPipelineDescriptor {
	...
	label?: string;
	layout?: object | GPUPipelineLayoutAuto;
...
export const enum ImageBitmapOptionsPremultiplyAlpha {
	premultiply = 'premultiply',
	none = 'none',
	default = 'default',
}
export const enum ImageBitmapOptionsColorSpaceConversion {
	default = 'default',
	none = 'none',
}
export const enum ImageBitmapOptionResizeQuality {
	low = 'low',
	medium = 'medium',
	high = 'high',
	pixelated = 'pixelated',
...
export interface ImageBitmapOptions {
	imageOrientation?: ImageBitmapOptionsImageOrientation;
	premultiplyAlpha?: ImageBitmapOptionsPremultiplyAlpha;
	colorSpaceConversion?: ImageBitmapOptionsColorSpaceConversion;
	resizeWidth?: number;
	resizeHeight?: number;
	resizeQuality?: ImageBitmapOptionResizeQuality;
}
export declare function createImageBitmap(source: ImageAsset | ImageBitmap | ImageData | Uint8Array, sxOrOptions?: ImageBitmapOptions | number | undefined | null, sy?: number | undefined | null, sw?: number | undefined | null, sh?: number | undefined | null, options?: ImageBitmapOptions | undefined | null): Promise<ImageBitmap>;
...
export type g_p_u_command_encoder = GPUCommandEncoder;
export declare class GPUCommandEncoder {
	get label(): string;
	beginComputePass(descriptor?: GPUComputePassDescriptor | undefined | null): g_p_u_compute_pass_encoder;
	beginRenderPass(descriptor: GPURenderPassDescriptor): g_p_u_render_pass_encoder;
	clearBuffer(buffer: g_p_u_buffer, offset?: number | undefined | null, size?: number | undefined | null): void;
	copyBufferToBuffer(source: g_p_u_buffer, sourceOffset: number, destination: g_p_u_buffer, destinationOffset: number, size: number): void;
	copyBufferToTexture(source: GPUImageCopyBuffer, destination: GPUImageCopyTexture, copySize: GPUExtent3DDict | Array<number>): void;
	copyTextureToBuffer(source: GPUImageCopyTexture, destination: GPUImageCopyBuffer, copySize: GPUExtent3DDict | Array<number>): void;
	copyTextureToTexture(source: GPUImageCopyTexture, destination: GPUImageCopyTexture, copySize: GPUExtent3DDict | Array<number>): void;
	finish(descriptor?: GpuCommandEncoderFinishDescriptor | undefined | null): GPUCommandBuffer;
	insertDebugMarker(markerLabel: string): void;
	popDebugGroup(): void;
	pushDebugGroup(groupLabel: string): void;
	resolveQuerySet(querySet: g_p_u_query_set, firstQuery: number, queryCount: number, destination: g_p_u_buffer, destinationOffset: number): void;
	writeTimestamp(querySet: g_p_u_query_set, queryIndex: number): void;
}
...
export declare class GPUDevice {
	...
	createPipelineLayout(descriptor: GPUPipelineLayoutDescriptor): g_p_u_pipeline_layout;
	createRenderPipeline(descriptor: GPURenderPipelineDescriptor): g_p_u_render_pipeline;
	createQuerySet(descriptor: GPUQuerySetDescriptor): g_p_u_query_set;
	createRenderBundleEncoder(descriptor: GPURenderBundleEncoderDescriptor): g_p_u_render_bundle_encoder;
	createShaderModule(descriptor: GPUShaderModuleDescriptor): g_p_u_shader_module;
	destroy(): void;
	createSampler(descriptor?: GPUSamplerDescriptor | undefined | null): g_p_u_sampler;
	createTexture(descriptor: GPUTextureDescriptor): g_p_u_texture | null;
...
export type g_p_u_query_set = GPUQuerySet;
export declare class GPUQuerySet {
	get label(): string;
}
export type g_p_u_queue = GPUQueue;
export declare class GPUQueue {
	get label(): string;
	copyExternalImageToTexture(source: GPUImageCopyExternalImage, destination: GPUImageCopyTextureTagged, copySize: Array<number> | GpuExtent3DDict): void;
	writeBuffer(buffer: g_p_u_buffer, bufferOffset: number, data: ArrayBuffer | Uint8Array | Float32Array | Uint32Array, dataOffset?: number | undefined | null, size?: number | undefined | null): void;
	writeTexture(destination: GpuImageCopyTexture, data: Uint8Array | Uint16Array | Uint32Array | ArrayBuffer, dataLayout: GPUImageDataLayout, size: Array<number> | GpuExtent3DDict): void;
	submit(buffers: Array<GPUCommandBuffer>): void;
}
export type g_p_u_render_pass_encoder = GPURenderPassEncoder;
export declare class GPURenderPassEncoder {
	...
	drawIndexed(indexCount: number, instanceCount?: number | undefined | null, firstVertex?: number | undefined | null, baseVertex?: number | undefined | null, firstInstance?: number | undefined | null): void;
	drawIndexedIndirect(indirectBuffer: g_p_u_buffer, indirectOffset: number): void;
	drawIndirect(indirectBuffer: g_p_u_buffer, indirectOffset: number): void;
	multiDrawIndexedIndirect(indirectBuffer: g_p_u_buffer, indirectOffset: number, count?: number | undefined | null): void;
	multiDrawIndirect(indirectBuffer: g_p_u_buffer, indirectOffset: number, count?: number | undefined | null): void;
	end(): void;
	endOcclusionQuery(): void;
	executeBundles(bundles: Array<g_p_u_render_bundle>): void;
	insertDebugMarker(markerLabel: string): void;
	popDebugGroup(): void;
	pushDebugGroup(groupLabel: string): void;
	setBindGroup(index: number, bindGroup: GPUBindGroup, dynamicOffsetsData?: Array<number> | Uint32Array | undefined | null, dynamicOffsetsDataStart?: number | undefined | null, dynamicOffsetsDataLength?: number | undefined | null): void;
	setBlendConstant(color: GpuColorDict | Array<number>): void;
	setIndexBuffer(buffer: g_p_u_buffer, indexFormat: GPUIndexFormat, offset?: number | undefined | null, size?: number | undefined | null): void;
	setPipeline(renderPipeline: g_p_u_render_pipeline): void;
	setScissorRect(x: number, y: number, width: number, height: number): void;
	setStencilReference(reference: number): void;
	setVertexBuffer(slot: number, buffer: g_p_u_buffer, offset?: number | undefined | null, size?: number | undefined | null): void;
...
export declare class GPUTexture {
	...
	get height(): number;
	get usage(): number;
	createView(descriptor?: GPUTextureViewDescriptor | undefined | null): g_p_u_texture_view;
	destroy(): void;
}
export type g_p_u_texture_view = GPUTextureView;
...
export type g_p_u_compute_pass_encoder = GPUComputePassEncoder;
export declare class GPUComputePassEncoder {
	...
	pushDebugGroup(groupLabel: string): void;
	setBindGroup(index: number, bindGroup: GPUBindGroup, dynamicOffsetsData?: Array<number> | Uint32Array | undefined | null, dynamicOffsetsDataStart?: number | undefined | null, dynamicOffsetsDataLength?: number | undefined | null): void;
	setPipeline(renderPipeline: g_p_u_compute_pipeline): void;
}
...
export type g_p_u_render_bundle = GPURenderBundle;
export declare class GPURenderBundle {
	get label(): string;
}
export type g_p_u_render_bundle_encoder = GPURenderBundleEncoder;
