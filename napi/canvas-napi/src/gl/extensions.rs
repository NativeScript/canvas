...
impl WEBGL_draw_buffers {
  ...
  #[napi(getter)]
  pub fn get_color_attachment1_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT1
  }

  #[napi(getter)]
  pub fn get_color_attachment2_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT2
  }

  #[napi(getter)]
  pub fn get_color_attachment3_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT3
  }

  #[napi(getter)]
  pub fn get_color_attachment4_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT4
  }

  #[napi(getter)]
  pub fn get_color_attachment5_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT5
  }

  #[napi(getter)]
  pub fn get_color_attachment6_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT6
  }

  #[napi(getter)]
  pub fn get_color_attachment7_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT7
  }

  #[napi(getter)]
  pub fn get_color_attachment8_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT8
  }

  #[napi(getter)]
  pub fn get_color_attachment9_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT9
  }

  #[napi(getter)]
  pub fn get_color_attachment10_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT10
  }

  #[napi(getter)]
  pub fn get_color_attachment11_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT11
  }

  #[napi(getter)]
  pub fn get_color_attachment12_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT12
  }

  #[napi(getter)]
  pub fn get_color_attachment13_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT13
  }

  #[napi(getter)]
  pub fn get_color_attachment14_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT14
  }

  #[napi(getter)]
  pub fn get_color_attachment15_webgl(&self) -> u32 {
    gl_bindings::COLOR_ATTACHMENT15
  }

  #[napi(getter)]
  pub fn get_draw_buffer0_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER0
  }
  #[napi(getter)]
  pub fn draw_buffer1_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER1
  }
  #[napi(getter)]
  pub fn draw_buffer2_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER2
  }
  #[napi(getter)]
  pub fn draw_buffer3_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER3
  }
  #[napi(getter)]
  pub fn draw_buffer4_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER4
  }
  #[napi(getter)]
  pub fn draw_buffer5_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER5
  }
  #[napi(getter)]
  pub fn draw_buffer6_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER6
  }
  #[napi(getter)]
  pub fn draw_buffer7_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER7
  }
  #[napi(getter)]
  pub fn draw_buffer8_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER8
  }
  #[napi(getter)]
  pub fn draw_buffer9_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER9
  }
  #[napi(getter)]
  pub fn draw_buffer10_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER10
  }
  #[napi(getter)]
  pub fn draw_buffer11_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER11
  }
  #[napi(getter)]
  pub fn draw_buffer12_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER12
  }
  #[napi(getter)]
  pub fn draw_buffer13_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER13
  }
  #[napi(getter)]
  pub fn draw_buffer14_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER14
  }
  #[napi(getter)]
  pub fn draw_buffer15_webgl(&self) -> u32 {
    gl_bindings::DRAW_BUFFER15
  }
  #[napi(getter)]
  pub fn max_color_attachments_webgl(&self) -> u32 {
    gl_bindings::MAX_COLOR_ATTACHMENTS
  }
  #[napi(getter)]
  pub fn max_draw_buffers_webgl(&self) -> u32 {
