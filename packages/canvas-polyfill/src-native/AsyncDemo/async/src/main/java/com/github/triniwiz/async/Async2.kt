...
public class Async2 {
    ...
    class Http {
        ...
        internal class ProgressRequestBody(var body: RequestBody, var listener: ProgressListener?) : RequestBody() {
        ...
        internal class DownloadCallOptions(var call: Call, var options: DownloadRequestOptions, var callback: Callback)
