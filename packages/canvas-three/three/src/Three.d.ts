...
export type { WebGLProgramParameters, WebGLProgramParametersWithUniforms, WebGLPrograms } from './renderers/webgl/WebGLPrograms.js';
...
export type { WebGLColorBuffer, WebGLDepthBuffer, WebGLState, WebGLStencilBuffer } from './renderers/webgl/WebGLState.js';
...
export type { WebXRController, WebXRSpaceEventMap, XRControllerEventType, XRGripSpace, XRHandInputState, XRHandJoints, XRHandSpace, XRJointSpace, XRTargetRaySpace } from './renderers/webxr/WebXRController.js';
export type { WebXRDepthSensing } from './renderers/webxr/WebXRDepthSensing.js';
export type { WebXRArrayCamera, WebXRCamera, WebXRManager, WebXRManagerEventMap } from './renderers/webxr/WebXRManager.js';
