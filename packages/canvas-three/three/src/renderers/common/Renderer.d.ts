...
declare class Renderer {
	...
	_mrt: MRTNode | null;
	_renderObjectFunction: ((object: Object3D, scene: Scene, camera: Camera, geometry: BufferGeometry, material: Material, group: GeometryGroup, lightsNode: LightsNode) => void) | null;
	_currentRenderObjectFunction: ((object: Object3D, scene: Scene, camera: Camera, geometry: BufferGeometry, material: Material, group: GeometryGroup, lightsNode: LightsNode) => void) | null;
	_currentRenderBundle: RenderBundle | null;
	_handleObjectFunction: (object: Object3D, material: Material, scene: Scene, camera: Camera, lightsNode: LightsNode, group: GeometryGroup, passId?: string) => void;
	...
	debug: {
		...
		onShaderError: ((gl: WebGL2RenderingContext, programGPU: WebGLProgram, glVertexShader: WebGLShader, glFragmentShader: WebGLShader) => void) | null;
	};
	...
	setRenderObjectFunction(renderObjectFunction: ((object: Object3D, scene: Scene, camera: Camera, geometry: BufferGeometry, material: Material, group: GeometryGroup, lightsNode: LightsNode) => void) | null): void;
	getRenderObjectFunction(): ((object: Object3D, scene: Scene, camera: Camera, geometry: BufferGeometry, material: Material, group: GeometryGroup, lightsNode: LightsNode) => void) | null;
	...
	readRenderTargetPixelsAsync(renderTarget: RenderTarget, x: number, y: number, width: number, height: number, index?: number): Promise<import('../../core/BufferAttribute.js').TypedArray>;
	...
	renderObject(object: Object3D, scene: Scene, camera: Camera, geometry: BufferGeometry, material: Material, group: GeometryGroup, lightsNode: LightsNode): void;
	_renderObjectDirect(object: Object3D, material: Material, scene: Scene, camera: Camera, lightsNode: LightsNode, group: GeometryGroup, passId?: string): void;
	_createObjectPipeline(object: Object3D, material: Material, scene: Scene, camera: Camera, lightsNode: LightsNode, group: GeometryGroup, passId?: string): void;
