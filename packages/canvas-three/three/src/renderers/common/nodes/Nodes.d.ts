...
import { ComputeNode, LightsNode, Node, NodeBuilder, NodeFrame, ShaderNodeObject, UniformGroupNode } from '../../../nodes/Nodes.js';
...
declare class Nodes extends DataMap<{
	...
	>;
	groupsData: ChainMap<
		readonly [UniformGroupNode, NodeUniformsGroup],
		{
			version?: number;
		}
	>;
	...
	delete(object: NodeUniformsGroup | RenderObject | ComputeNode | Scene): SceneData | RenderObjectData | NodeUniformsGroupData | ComputeNodeData;
	...
	getNodeFrame(renderer?: Renderer, scene?: Scene | null, object?: Object3D | null, camera?: Camera | null, material?: Material | null): NodeFrame;
