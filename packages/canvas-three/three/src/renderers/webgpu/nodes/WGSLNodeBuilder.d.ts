...
export default class WGSLNodeBuilder extends NodeBuilder {
	...
	_generateTextureSample(texture: Texture, textureProperty: string, uvSnippet: string, depthSnippet: string | null, shaderStage: NodeShaderStage): string;
	_generateVideoSample(textureProperty: string, uvSnippet: string, shaderStage: NodeShaderStage): string;
	_generateTextureSampleLevel(texture: Texture, textureProperty: string, uvSnippet: string, levelSnippet: string, depthSnippet: string | null, shaderStage: NodeShaderStage): string;
	generateTextureLod(texture: Texture, textureProperty: string, uvSnippet: string, levelSnippet: string): string;
	generateTextureLoad(texture: Texture, textureProperty: string, uvIndexSnippet: string, depthSnippet: string | null, shaderStage: NodeShaderStage): string;
	generateTextureStore(texture: Texture, textureProperty: string, uvIndexSnippet: string, valueSnippet: string): string;
	isUnfilterable(texture: Texture): boolean;
	generateTexture(texture: Texture, textureProperty: string, uvSnippet: string, depthSnippet: string | null, shaderStage: NodeShaderStage): string;
	generateTextureGrad(texture: Texture, textureProperty: string, uvSnippet: string, gradSnippet: string[], depthSnippet: string | null, shaderStage: NodeShaderStage): string;
	generateTextureCompare(texture: Texture, textureProperty: string, uvSnippet: string, compareSnippet: String, shaderStage: NodeShaderStage): string;
	generateTextureLevel(texture: Texture, textureProperty: string, uvSnippet: string, levelSnippet: string, depthSnippet: string | null, shaderStage: NodeShaderStage): string;
