...
public:
    ...
    std::shared_ptr<ConcurrentMap<intptr_t, std::shared_ptr<OnImageBitmapLoadCallbackHolder>>> OnImageBitmapLoadCallbackHolder_ = std::make_shared<ConcurrentMap<intptr_t, std::shared_ptr<OnImageBitmapLoadCallbackHolder>>>();
