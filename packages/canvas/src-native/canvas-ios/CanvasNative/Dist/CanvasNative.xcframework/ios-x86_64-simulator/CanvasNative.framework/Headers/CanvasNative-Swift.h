...
typedef SWIFT_ENUM(NSInteger, CanvasColorStyleType, open) {
...
SWIFT_CLASS("_TtC12CanvasNative13MetalRenderer")
...
@property (nonatomic) int64_t canvas;
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull canvasState;
- (void)doDraw;
- (void)flush;
- (nonnull instancetype)initWithFrame:(CGRect)frame useGL:(BOOL)useGL OBJC_DESIGNATED_INITIALIZER;
...
enum TNSImageSmoothingQuality : NSInteger;
...
@property (nonatomic, strong) TNSDOMMatrix * _Nonnull currentTransform;
...
@property (nonatomic) id _Nonnull shadowColor;
...
- (void)fill:(TNSPath2D * _Nonnull)path :(NSString * _Nonnull)rule;
- (void)stroke;
- (void)stroke:(TNSPath2D * _Nonnull)path;
- (void)beginPath;
...
- (void)clip:(TNSPath2D * _Nonnull)path :(NSString * _Nonnull)rule;
...
- (id _Nonnull)createPattern:(id _Nonnull)value :(enum TNSPatternRepetition)repetition SWIFT_WARN_UNUSED_RESULT;
...
- (TNSImageData * _Nonnull)createImageData:(NSInteger)width :(NSInteger)height SWIFT_WARN_UNUSED_RESULT;
- (TNSImageData * _Nonnull)createImageData:(TNSImageData * _Nonnull)imageData SWIFT_WARN_UNUSED_RESULT;
- (TNSImageData * _Nonnull)getImageData:(float)sx :(float)sy :(NSInteger)sw :(NSInteger)sh SWIFT_WARN_UNUSED_RESULT;
- (void)putImageData:(TNSImageData * _Nonnull)imageData :(float)dx :(float)dy;
- (void)putImageData:(TNSImageData * _Nonnull)imageData :(float)dx :(float)dy :(float)dirtyX :(float)dirtyY :(NSInteger)dirtyWidth :(NSInteger)dirtyHeight;
...
- (BOOL)isPointInPath:(float)x :(float)y :(NSString * _Nonnull)fillRule SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isPointInPath:(TNSPath2D * _Nonnull)path :(float)x :(float)y :(NSString * _Nonnull)fillRule SWIFT_WARN_UNUSED_RESULT;
...
@interface Color : NSObject <ICanvasColorStyle>
- (nonnull instancetype)initWithColor:(UIColor * _Nullable)color OBJC_DESIGNATED_INITIALIZER;
- (enum CanvasColorStyleType)getStyleType SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface Gradient : NSObject <ICanvasColorStyle>
- (enum CanvasColorStyleType)getStyleType SWIFT_WARN_UNUSED_RESULT;
- (void)addColorStopWithOffset:(float)offset color:(uint32_t)color;
- (void)addColorStopWithOffsetUIColor:(float)offset :(UIColor * _Nonnull)color;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS_NAMED("TNSLinearGradient")
@interface TNSLinearGradient : Gradient
- (nonnull instancetype)initWithX0:(float)x0 y0:(float)y0 x1:(float)x1 y1:(float)y1 OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface TNSRadialGradient : Gradient
- (nonnull instancetype)initWithX0:(float)x0 y0:(float)y0 r0:(float)r0 x1:(float)x1 y1:(float)y1 r1:(float)r1 OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithSrc:(UIImage * _Nonnull)src pattern:(enum TNSPatternRepetition)pattern OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCanvas:(TNSCanvas * _Nonnull)canvas pattern:(enum TNSPatternRepetition)pattern OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithAsset:(TNSImageAsset * _Nonnull)src pattern:(enum TNSPatternRepetition)pattern OBJC_DESIGNATED_INITIALIZER;
...
typedef SWIFT_ENUM(NSInteger, TNSCompositeOperationType, open) {
...
typedef SWIFT_ENUM(NSInteger, TNSImageSmoothingQuality, open) {
...
typedef SWIFT_ENUM(NSInteger, TNSLineCap, open) {
  TNSLineCapButt = 0,
  TNSLineCapRound = 1,
  TNSLineCapSquare = 2,
};

typedef SWIFT_ENUM(NSInteger, TNSLineJoin, open) {
  TNSLineJoinBevel = 0,
  TNSLineJoinRound = 1,
  TNSLineJoinMiter = 2,
};
...
typedef SWIFT_ENUM(NSInteger, TNSTextAlignment, open) {
  TNSTextAlignmentLeft = 0,
  TNSTextAlignmentStart = 1,
  TNSTextAlignmentCenter = 2,
  TNSTextAlignmentEnd = 3,
  TNSTextAlignmentRight = 4,
};
...
@interface UIColor (SWIFT_EXTENSION(CanvasNative))
- (nonnull instancetype)initFromString:(NSString * _Nonnull)string;
- (nonnull instancetype)initFromHex:(NSString * _Nonnull)hex;
@end
