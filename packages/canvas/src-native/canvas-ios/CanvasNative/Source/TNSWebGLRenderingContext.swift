...
public class TNSWebGLRenderingContext: TNSCanvasRenderingContext {
    ...
    public func bufferData(_ target: UInt32, srcData: UnsafeMutableRawPointer, size: Int, _ usage: UInt32){
        bufferData(target, srcData: srcData, size: size, usage, offset: 0)
    }
    
    public func bufferData(_ target: UInt32, srcData: UnsafeMutableRawPointer, size: Int, _ usage: UInt32, offset: Int){
        canvas.renderer.ensureIsContextIsCurrent()
        glBufferData(target, size , srcData.advanced(by: offset), usage)
    }
    ...
    public func bufferSubData(_ target: UInt32,_ offset: Int, srcData: UnsafeMutableRawPointer, size: Int){
        bufferSubData(target, offset, srcData: srcData, size: size, os: 0)
    }
    
    public func bufferSubData(_ target: UInt32,_ offset: Int, srcData: UnsafeMutableRawPointer, size: Int, os: Int){
        canvas.renderer.ensureIsContextIsCurrent()
        glBufferSubData(target, offset, size, srcData.advanced(by: os))
    }
    ...
    public func readPixels(_ x: Int32,_ y: Int32,_ width: Int32,_ height: Int32,_ format: UInt32,_ type: UInt32,_ pixels: UnsafeMutableRawPointer) {
        readPixels(x, y, width, height, format, type, pixels, offset: 0)
    }
    
    public func readPixels(_ x: Int32,_ y: Int32,_ width: Int32,_ height: Int32,_ format: UInt32,_ type: UInt32,_ pixels: UnsafeMutableRawPointer, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        clearIfComposited()
        glReadPixels(x, y, width, height, format, type, pixels.advanced(by: offset))
    ...
    public func texImage2D(_ target: UInt32,_ level: Int32,_ internalformat: Int32,_ width: Int32,_ height: Int32,_ border: Int32,_ format: UInt32,_ type: UInt32, pixels: UnsafeRawPointer, size: Int) {
        texImage2D(target, level, internalformat, width, height, border, format, type, pixels: pixels, size: size, offset: 0)
    }
    
    public func texImage2D(_ target: UInt32,_ level: Int32,_ internalformat: Int32,_ width: Int32,_ height: Int32,_ border: Int32,_ format: UInt32,_ type: UInt32, pixels: UnsafeRawPointer, size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        if(flipYWebGL){
            var px = Data(bytes: pixels, count: size)
            px.withUnsafeMutableBytes { ptr in
                let pointer = ptr.baseAddress?.assumingMemoryBound(to: UInt8.self).advanced(by: offset)
            ...
            glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels.advanced(by: offset))
        }
    ...
    public func texSubImage2D(_ target: UInt32,_ level: Int32,_ xoffset: Int32,_ yoffset: Int32,_ width: Int32,_ height: Int32, _ format: UInt32,_ type: UInt32,pixels: UnsafeMutableRawPointer, size: Int) {
        texSubImage2D(target, level, xoffset,yoffset, width, height, format, type, pixels: pixels, size: size, offset: 0)
    }
    
    
    public func texSubImage2D(_ target: UInt32,_ level: Int32,_ xoffset: Int32,_ yoffset: Int32,_ width: Int32,_ height: Int32, _ format: UInt32,_ type: UInt32,pixels: UnsafeMutableRawPointer, size: Int, offset: Int){
        canvas.renderer.ensureIsContextIsCurrent()
    ...
    public func uniform1fv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int) {
        uniform1fv(location, value, size, offset: 0)
    }
    
    public func uniform1fv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniform1fv(location, GLint(size/1), value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
    ...
    public func uniform1iv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int) {
        uniform1iv(location, value, size, offset: 0)
    }
    
    public func uniform1iv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniform1iv(location, GLint(size / 1), value.assumingMemoryBound(to: GLint.self).advanced(by: offset))
    }
    ...
    public func uniform2fv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int) {
        uniform2fv(location, value, size, offset: 0)
    }
    
    public func uniform2fv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniform1fv(location, GLint(size / 2), value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
    ...
    public func uniform2iv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int) {
        uniform2iv(location, value, size, offset: 0)
    }
    
    public func uniform2iv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniform2iv(location, GLint(size / 2), value.assumingMemoryBound(to: GLint.self).advanced(by: offset))
    }
    ...
    public func uniform3fv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int) {
        uniform3fv(location, value, size, offset: 0)
    }
    
    public func uniform3fv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniform3fv(location, GLint(size / 3), value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
    ...
    public func uniform3iv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int) {
        uniform3iv(location, value, size, offset: 0)
    }
    
    public func uniform3iv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniform3iv(location, GLint(size / 3), value.assumingMemoryBound(to: GLint.self).advanced(by: offset))
    }
    ...
    public func uniform4fv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int) {
        uniform4fv(location, value, size, offset: 0)
    }
    
    public func uniform4fv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniform4fv(location, GLint(size / 4), value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
    ...
    public func uniform4iv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int) {
        uniform4iv(location, value, size, offset: 0)
    }
    
    public func uniform4iv(_ location: Int32, _ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniform4iv(location, GLint(size / 4) , value.assumingMemoryBound(to: GLint.self).advanced(by: offset))
    }
    
    public func uniformMatrix2fv(_ location: Int32,_ transpose: Bool,_ value: UnsafeMutableRawPointer,_ size: Int) {
        uniformMatrix2fv(location, transpose, value, size, offset: 0)
    }
    
    public func uniformMatrix2fv(_ location: Int32,_ transpose: Bool,_ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniformMatrix2fv(location,GLsizei(size / 4), boolConverter(transpose), value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
    
    public func uniformMatrix3fv(_ location: Int32,_ transpose: Bool,_ value: UnsafeMutableRawPointer,_ size: Int) {
        uniformMatrix3fv(location, transpose, value, size, offset: 0)
    }
    
    public func uniformMatrix3fv(_ location: Int32,_ transpose: Bool,_ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniformMatrix3fv(location, GLsizei(size / 9), boolConverter(transpose), value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
    
    public func uniformMatrix4fv(_ location: Int32,_ transpose: Bool, _ value: UnsafeMutableRawPointer,_ size: Int){
        uniformMatrix4fv(location, transpose, value, size, offset: 0)
    }
    
    public func uniformMatrix4fv(_ location: Int32,_ transpose: Bool, _ value: UnsafeMutableRawPointer,_ size: Int, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glUniformMatrix4fv(location, GLsizei(size / 16), boolConverter(transpose), value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
    ...
    public func vertexAttrib1fv(_ index: UInt32,_ value: UnsafeMutableRawPointer) {
        vertexAttrib1fv(index, value, offset: 0)
    }
    
    public func vertexAttrib1fv(_ index: UInt32,_ value: UnsafeMutableRawPointer, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glVertexAttrib1fv(index,value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
    
    public func vertexAttrib2fv(_ index: UInt32,_ value: UnsafeMutableRawPointer) {
        vertexAttrib2fv(index, value, offset: 0)
    }
    
    public func vertexAttrib2fv(_ index: UInt32,_ value: UnsafeMutableRawPointer, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glVertexAttrib2fv(index,value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
    
    public func vertexAttrib3fv(_ index: UInt32, _ value: UnsafeMutableRawPointer){
        vertexAttrib3fv(index, value, offset: 0)
    }
    
    public func vertexAttrib3fv(_ index: UInt32, _ value: UnsafeMutableRawPointer, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glVertexAttrib3fv(GLuint(index),value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
    
    
    public func vertexAttrib4fv(_ index: UInt32, _ value: UnsafeMutableRawPointer) {
        vertexAttrib4fv(index, value, offset: 0)
    }
    
    public func vertexAttrib4fv(_ index: UInt32, _ value: UnsafeMutableRawPointer, offset: Int) {
        canvas.renderer.ensureIsContextIsCurrent()
        glVertexAttrib4fv(index,value.assumingMemoryBound(to: GLfloat.self).advanced(by: offset))
    }
