...
#ifndef CANVAS_NATIVE_CANVASRENDERINGCONTEXT2DIMPL_H
#define CANVAS_NATIVE_CANVASRENDERINGCONTEXT2DIMPL_H
...
#include "canvas-v8-android/src/bridges/canvas_rendering_context_2d.h"
...
#endif //CANVAS_NATIVE_CANVASRENDERINGCONTEXT2DIMPL_H
