...
WebGLRenderingContext::WebGLRenderingContext(rust::Box<WebGLState> state) : state_(std::move(state)) {
...
void WebGLRenderingContext::UpdateInvalidateState() {
    auto raf = this->raf_.get();
    if (raf != nullptr) {
...
InvalidateState WebGLRenderingContext::GetInvalidateState() const {
    return this->invalidateState_;
}

void WebGLRenderingContext::SetInvalidateState(InvalidateState state) {
...
void WebGLRenderingContext::Flush(intptr_t context) {
    auto ctx = reinterpret_cast<WebGLRenderingContext *>(reinterpret_cast<intptr_t *>(context));
    if (ctx != nullptr) {
        ctx->Flush();
    }
}
...
void WebGLRenderingContext::Init(v8::Isolate *isolate) {
    ...
    global->Set(context, Helpers::ConvertToV8String(isolate, "WebGLRenderingContext"), ctorFunc);
...
void WebGLRenderingContext::InstanceFromPointer(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 0 && args[0]->IsObject()) {
        ...
        if (version.compare("v1") == 0 || version.compare("v2") == 0) {
            ...
            auto ret = cache->WebGLRenderingContextTmpl->Get(isolate)->InstanceTemplate()->NewInstance(
...
void WebGLRenderingContext::ActiveTexture(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 0 && args[0]->IsNumber()) {
        ...
        canvas_native_webgl_active_texture(texture.ToLocalChecked()->Value(), *ptr->state_);
    }
}
...
void WebGLRenderingContext::BindBuffer(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 1) {
        ...
        if (Helpers::IsInstanceOf(isolate, buffer, "WebGLBuffer") && target->IsNumber()) {
            auto b = buffer.As<v8::Object>();
...
void WebGLRenderingContext::BindFramebuffer(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 1) {
        ...
        if (Helpers::IsInstanceOf(isolate, framebuffer, "WebGLFramebuffer") && target->IsNumber()) {
...
void WebGLRenderingContext::CreateBuffer(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto context = isolate->GetCurrentContext();
    auto ptr = GetPointer(args.Holder());
    auto buffer = canvas_native_webgl_create_buffer(*ptr->state_);
    if (buffer == 0) {
        args.GetReturnValue().Set(v8::Undefined(isolate));
    } else {
        auto ctor = WebGLBuffer::GetCtor(isolate);
        auto instance = ctor->NewInstance(context).ToLocalChecked();
...
void WebGLRenderingContext::CreateFramebuffer(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto context = isolate->GetCurrentContext();
    auto ptr = GetPointer(args.Holder());
    auto ret = canvas_native_webgl_create_framebuffer(*ptr->state_);
    if (ret == 0) {
        args.GetReturnValue().Set(v8::Undefined(isolate));
        return;
    }
...
void WebGLRenderingContext::CreateProgram(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto context = isolate->GetCurrentContext();
    auto ptr = GetPointer(args.Holder());
    auto ret = canvas_native_webgl_create_program(*ptr->state_);
    if (ret == 0) {
        args.GetReturnValue().Set(v8::Undefined(isolate));
        return;
    }
...
void WebGLRenderingContext::CreateRenderbuffer(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto context = isolate->GetCurrentContext();
    auto ptr = GetPointer(args.Holder());
    auto ret = canvas_native_webgl_create_renderbuffer(*ptr->state_);
    if (ret == 0) {
        args.GetReturnValue().Set(v8::Undefined(isolate));
        return;
    }
...
void WebGLRenderingContext::CreateShader(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto ret = canvas_native_webgl_create_shader(type, *ptr->state_);
    if (ret == 0) {
        args.GetReturnValue().Set(v8::Undefined(isolate));
        return;
    }
...
void WebGLRenderingContext::CreateTexture(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto context = isolate->GetCurrentContext();
    auto ptr = GetPointer(args.Holder());
    auto ret = canvas_native_webgl_create_texture(*ptr->state_);
    if (ret == 0) {
        args.GetReturnValue().Set(v8::Undefined(isolate));
        return;
    }
...
void WebGLRenderingContext::GetContextAttributes(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto context = isolate->GetCurrentContext();
    auto ptr = GetPointer(args.Holder());
    auto attr = canvas_native_webgl_get_context_attributes(*ptr->state_);
...
void WebGLRenderingContext::GetError(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto context = isolate->GetCurrentContext();
    auto ptr = GetPointer(args.Holder());
    auto ret = canvas_native_webgl_get_error(*ptr->state_);
    args.GetReturnValue().Set(ret);
}
...
void WebGLRenderingContext::VertexAttrib1f(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 2) {
        ...
        canvas_native_webgl_vertex_attrib1f(index, v0, *ptr->state_);
    }
}
...
void WebGLRenderingContext::VertexAttrib1fv(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 2) {
        ...
        if (v0->IsFloat32Array()) {
            ...
            canvas_native_webgl_vertex_attrib1fv(index, buf, *ptr->state_);
        }
    }
}
...
void WebGLRenderingContext::VertexAttrib2f(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 3) {
        ...
        canvas_native_webgl_vertex_attrib2f(index, v0, v1, *ptr->state_);
    }
}
...
void WebGLRenderingContext::VertexAttrib2fv(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 2) {
        ...
        if (v0->IsFloat32Array()) {
            ...
            auto store = buffer->GetBackingStore();
            rust::Slice<const float> buf(static_cast<float *>(store->Data()), array->Length());
            canvas_native_webgl_vertex_attrib2fv(index, buf, *ptr->state_);
        }
    }
}
...
void WebGLRenderingContext::VertexAttrib3f(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 4) {
        ...
        canvas_native_webgl_vertex_attrib3f(index, v0, v1, v2, *ptr->state_);
    }
}
...
void WebGLRenderingContext::VertexAttrib3fv(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 2) {
        ...
        if (v0->IsFloat32Array()) {
            ...
            auto store = buffer->GetBackingStore();
            rust::Slice<const float> buf(static_cast<float *>(store->Data()), array->Length());
            canvas_native_webgl_vertex_attrib3fv(index, buf, *ptr->state_);
        }
    }
}
...
void WebGLRenderingContext::VertexAttrib4f(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 5) {
        ...
        canvas_native_webgl_vertex_attrib4f(index, v0, v1, v2, v3, *ptr->state_);
    }
}
...
void WebGLRenderingContext::VertexAttrib4fv(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 2) {
        ...
        if (v0->IsFloat32Array()) {
            ...
            auto store = buffer->GetBackingStore();
            rust::Slice<const float> buf(static_cast<float *>(store->Data()), array->Length());
            canvas_native_webgl_vertex_attrib4fv(index, buf, *ptr->state_);
        }
    }
}
...
void WebGLRenderingContext::VertexAttribPointer(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 6) {
        ...
        canvas_native_webgl_vertex_attrib_pointer(index, size, type, normalized, stride, offset, *ptr->state_);
    }
}
    ...
    if (args.Length() == 2) {
        ...
        if (Helpers::IsInstanceOf(isolate, location, "WebGLUniformLocation") && v0->IsInt32Array()) {
            ...
            if (!instance.IsEmpty()) {
                ...
                canvas_native_webgl_uniform1iv(instance->Int32Value(context).ToChecked(), buf, *ptr->state_);
            }
        }
    }
}
    ...
    if (args.Length() == 2) {
        ...
        if (Helpers::IsInstanceOf(isolate, location, "WebGLUniformLocation")) {
            ...
            if (v0->IsFloat32Array()) {
                ...
                auto store = buffer->GetBackingStore();
                rust::Slice<const float> buf(static_cast<float *>(store->Data()), array->Length());
                canvas_native_webgl_uniform1fv(instance->Int32Value(context).ToChecked(), buf, *ptr->state_);
            } else if (v0->IsArray()) {
                ...
                canvas_native_webgl_uniform1fv(instance->Int32Value(context).ToChecked(), slice, *ptr->state_);
            }
        }
    }
}
    ...
    if (args.Length() == 2) {
        ...
        if (Helpers::IsInstanceOf(isolate, location, "WebGLUniformLocation") && v0->IsInt32Array()) {
            ...
            if (!instance.IsEmpty()) {
                ...
                auto store = buffer->GetBackingStore();
                rust::Slice<const int32_t> buf(static_cast<int32_t *>(store->Data()), array->Length());
                canvas_native_webgl_uniform2iv(instance->Int32Value(context).ToChecked(), buf, *ptr->state_);
            }
        }
    }
}
    ...
    if (args.Length() == 2) {
        ...
        if (Helpers::IsInstanceOf(isolate, location, "WebGLUniformLocation")) {
            ...
            if (v0->IsFloat32Array()) {
                ...
                auto store = buffer->GetBackingStore();
                rust::Slice<const float> buf(static_cast<float *>(store->Data()), array->Length());
                canvas_native_webgl_uniform2fv(instance->Int32Value(context).ToChecked(), buf, *ptr->state_);
            } else if (v0->IsArray()) {
                auto array = v0.As<v8::Array>();
                auto len = array->Length();
                std::vector<float> buf;
                ...
                rust::Slice<const float> slice(buf.data(), buf.size());
                canvas_native_webgl_uniform2fv(instance->Int32Value(context).ToChecked(), slice, *ptr->state_);
            }
        }
    }
}
    ...
    if (args.Length() == 2) {
        ...
        if (Helpers::IsInstanceOf(isolate, location, "WebGLUniformLocation") && v0->IsInt32Array()) {
            ...
            if (!instance.IsEmpty()) {
                ...
                auto store = buffer->GetBackingStore();
                rust::Slice<const int32_t> buf(static_cast<int32_t *>(store->Data()), array->Length());
                canvas_native_webgl_uniform3iv(instance->Int32Value(context).ToChecked(), buf, *ptr->state_);
            }
        }
    }
}
    ...
    if (args.Length() == 2) {
        ...
        if (Helpers::IsInstanceOf(isolate, location, "WebGLUniformLocation")) {
            ...
            if (v0->IsFloat32Array()) {
                ...
                auto store = buffer->GetBackingStore();
                rust::Slice<const float> buf(static_cast<float *>(store->Data()), array->Length());
                canvas_native_webgl_uniform3fv(instance->Int32Value(context).ToChecked(), buf, *ptr->state_);
            } else if (v0->IsArray()) {
                auto array = v0.As<v8::Array>();
                auto len = array->Length();
                std::vector<float> buf;
                ...
                rust::Slice<const float> slice(buf.data(), buf.size());
                canvas_native_webgl_uniform3fv(instance->Int32Value(context).ToChecked(), slice, *ptr->state_);
            }
        }
    }
}
    ...
    if (args.Length() == 2) {
        ...
        if (Helpers::IsInstanceOf(isolate, location, "WebGLUniformLocation") && v0->IsInt32Array()) {
            ...
            if (!instance.IsEmpty()) {
                ...
                auto store = buffer->GetBackingStore();
                rust::Slice<const int32_t> buf(static_cast<int32_t *>(store->Data()), array->Length());
                canvas_native_webgl_uniform4iv(instance->Int32Value(context).ToChecked(), buf, *ptr->state_);
            }
        }
    }
}
    ...
    if (args.Length() == 2) {
        ...
        if (Helpers::IsInstanceOf(isolate, location, "WebGLUniformLocation")) {
            ...
            if (v0->IsFloat32Array()) {
                ...
                auto store = buffer->GetBackingStore();
                rust::Slice<const float> buf(static_cast<float *>(store->Data()), array->Length());
                canvas_native_webgl_uniform4fv(instance->Int32Value(context).ToChecked(), buf, *ptr->state_);
            } else if (v0->IsArray()) {
                auto array = v0.As<v8::Array>();
                auto len = array->Length();
                std::vector<float> buf;
                ...
                rust::Slice<const float> slice(buf.data(), buf.size());
                canvas_native_webgl_uniform4fv(instance->Int32Value(context).ToChecked(), slice, *ptr->state_);
            }
        }
    }
}
    ...
    if (args.Length() == 3) {
        ...
        if (Helpers::IsInstanceOf(isolate, location, "WebGLUniformLocation") && value->IsFloat32Array()) {
            ...
            canvas_native_webgl_uniform_matrix2fv(instance->Int32Value(context).ToChecked(),
                                                  transpose->BooleanValue(isolate), buf, *ptr->state_);
        }
    }
}
...
void WebGLRenderingContext::Viewport(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 4) {
        ...
        canvas_native_webgl_viewport(x, y, width, height, *ptr->state_);
    }
}

v8::Local<v8::Function> WebGLRenderingContext::GetCtor(v8::Isolate *isolate) {
    auto cache = Caches::Get(isolate);
    auto tmpl = cache->WebGLRenderingContextCtor.get();
    if (tmpl != nullptr) {
    ...
    auto func = webglRenderingContextFunc->GetFunction(context).ToLocalChecked();
    ...
    cache->WebGLRenderingContextCtor = std::make_unique<v8::Persistent<v8::Function>>(isolate, func);
...
void WebGLRenderingContext::GetExtension(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto ext = canvas_native_webgl_get_extension(
            Helpers::ConvertFromV8StringToString(isolate, name->ToString(context).ToLocalChecked()), *ptr->state_);
...
void WebGLRenderingContext::GetParameter(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 0) {
        ...
        auto result = canvas_native_webgl_get_parameter(pname->Uint32Value(context).ToChecked(), *ptr->state_);
        ...
        switch (pnameValue) {
            ...
            case UNPACK_COLORSPACE_CONVERSION_WEBGL:
                args.GetReturnValue().Set(
                        canvas_native_webgl_state_get_unpack_colorspace_conversion_webgl(*ptr->state_)
                );
            ...
            case UNPACK_FLIP_Y_WEBGL:
                args.GetReturnValue().Set(canvas_native_webgl_state_get_flip_y(*ptr->state_));
                break;
            case UNPACK_PREMULTIPLY_ALPHA_WEBGL:
                args.GetReturnValue().Set(canvas_native_webgl_state_get_premultiplied_alpha(*ptr->state_));
                break;
            case GL_BLEND:
            case GL_CULL_FACE:
            case GL_DEPTH_TEST:
...
void WebGLRenderingContext::GetSupportedExtensions(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto context = isolate->GetCurrentContext();
    auto ptr = GetPointer(args.Holder());
    auto exts = canvas_native_webgl_get_supported_extensions(*ptr->state_);
    auto len = exts.size();
    auto array = v8::Array::New(isolate, len);
    for (int i = 0; i < len; ++i) {
        auto item = exts[i];
    ...
    if (args.Length() > 1) {
        ...
        if (Helpers::IsInstanceOf(isolate, program, "WebGLProgram")) {
            ...
            if (!instance.IsEmpty()) {
                ...
                auto location = WebGLUniformLocation::GetCtor(isolate);
        ...
        if (Helpers::IsInstanceOf(isolate, program, "WebGLProgram") &&
            ...
            if (!programInstance.IsEmpty() && !locationInstance.IsEmpty()) {
                ...
                auto val = canvas_native_webgl_get_uniform(programInstance->Uint32Value(context).ToChecked(),
                                                           location->Uint32Value(context).ToChecked(), *ptr->state_);
...
void WebGLRenderingContext::GetVertexAttribOffset(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 1) {
        ...
        auto ret = canvas_native_webgl_get_vertex_attrib_offset(index->Uint32Value(context).ToChecked(),
                                                                pname->Uint32Value(context).ToChecked(), *ptr->state_);
...
void WebGLRenderingContext::IsBuffer(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 0) {
        ...
        if (Helpers::IsInstanceOf(isolate, buffer, "WebGLBuffer")) {
            auto instance = Helpers::GetPrivate(isolate, buffer.As<v8::Object>(), "instance");
            if (!instance.IsEmpty()) {
                auto ret = canvas_native_webgl_is_buffer(instance->Uint32Value(context).ToChecked(), *ptr->state_);
...
void WebGLRenderingContext::IsContextLost(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    auto context = isolate->GetCurrentContext();
    auto ptr = GetPointer(args.Holder());
    auto ret = canvas_native_webgl_get_is_context_lost(*ptr->state_);
    args.GetReturnValue().Set(ret);
}
...
void WebGLRenderingContext::IsEnabled(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 1) {
        auto cap = args[0];
        auto ret = canvas_native_webgl_is_enabled(cap->Uint32Value(context).ToChecked(), *ptr->state_);
        args.GetReturnValue().Set(ret);
        return;
    }
    args.GetReturnValue().Set(false);
...
void WebGLRenderingContext::IsFramebuffer(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 0) {
        ...
        if (Helpers::IsInstanceOf(isolate, framebuffer, "WebGLFramebuffer")) {
            ...
            if (!instance.IsEmpty()) {
                auto ret = canvas_native_webgl_is_framebuffer(instance->Uint32Value(context).ToChecked(), *ptr->state_);
...
void WebGLRenderingContext::IsProgram(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 0) {
        ...
        if (Helpers::IsInstanceOf(isolate, program, "WebGLProgram")) {
            auto instance = Helpers::GetPrivate(isolate, program.As<v8::Object>(), "instance");
            if (!instance.IsEmpty()) {
                auto ret = canvas_native_webgl_is_program(instance->Uint32Value(context).ToChecked(), *ptr->state_);
...
void WebGLRenderingContext::IsShader(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 0) {
        ...
        if (Helpers::IsInstanceOf(isolate, shader, "WebGLShader")) {
            auto instance = Helpers::GetPrivate(isolate, shader.As<v8::Object>(), "instance");
            if (!instance.IsEmpty()) {
                auto ret = canvas_native_webgl_is_shader(instance->Uint32Value(context).ToChecked(), *ptr->state_);
...
void WebGLRenderingContext::IsTexture(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 0) {
        ...
        if (Helpers::IsInstanceOf(isolate, texture, "WebGLTexture")) {
            auto instance = Helpers::GetPrivate(isolate, texture.As<v8::Object>(), "instance");
            if (!instance.IsEmpty()) {
                auto ret = canvas_native_webgl_is_texture(instance->Uint32Value(context).ToChecked(), *ptr->state_);
...
void WebGLRenderingContext::LineWidth(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 0) {
        auto width = args[0];
        canvas_native_webgl_line_width(static_cast<float>(width->NumberValue(context).ToChecked()), *ptr->state_);
    }
}
...
void WebGLRenderingContext::LinkProgram(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 0) {
        ...
        if (Helpers::IsInstanceOf(isolate, program, "WebGLProgram")) {
            auto instance = Helpers::GetPrivate(isolate, program.As<v8::Object>(), "instance");
            if (!instance.IsEmpty()) {
                canvas_native_webgl_link_program(instance->Uint32Value(context).ToChecked(), *ptr->state_);
            }
        }
    }
}
...
void WebGLRenderingContext::ReadPixels(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() > 6) {
        ...
        rust::Slice<uint8_t> slice(static_cast<uint8_t *>(store->Data()), store->ByteLength());
...
void WebGLRenderingContext::TexImage2D(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    if (args.Length() == 5) {
        ...
        auto array = view->Buffer();
        auto store = array->GetBackingStore();
        rust::Slice<uint8_t> buf(static_cast<uint8_t *>(store->Data()), store->ByteLength());
