...
v8::Local <v8::Function> WEBGL_compressed_texture_etc1Impl::GetCtor(v8::Isolate *isolate) {
    auto cache = Caches::Get(isolate);
    auto ctor = cache->WEBGL_compressed_texture_etc1ImplCtor.get();
    if (ctor != nullptr) {
    ...
    cache->WEBGL_compressed_texture_etc1ImplCtor = std::make_unique<v8::Persistent<v8::Function>>(isolate, func);
    return func;
}
...
v8::Local<v8::Object> WEBGL_compressed_texture_etc1Impl::NewInstance(v8::Isolate *isolate) {
    ...
    result->Set(context, Helpers::ConvertToV8String(isolate, "COMPRESSED_RGB_ETC1_WEBGL"), v8::Int32::New(isolate, GL_ETC1_RGB8_OES));
