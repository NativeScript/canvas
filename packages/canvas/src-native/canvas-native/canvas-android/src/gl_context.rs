...
use egl::{
    EGL_ALPHA_SIZE, EGL_BLUE_SIZE, EGL_BUFFER_PRESERVED, EGL_CONTEXT_CLIENT_VERSION, EGL_DEFAULT_DISPLAY, EGL_DEPTH_SIZE, EGL_EXTENSIONS,
    EGL_GREEN_SIZE, EGL_HEIGHT, EGL_NO_CONTEXT, EGL_NONE,
    EGL_OPENGL_ES2_BIT, EGL_OPENGL_ES_API, EGL_OPENGL_ES_BIT, EGL_PBUFFER_BIT, EGL_PIXMAP_BIT, EGL_RED_SIZE,
    EGL_RENDERABLE_TYPE, EGL_SAMPLE_BUFFERS, EGL_SAMPLES, EGL_STENCIL_SIZE, EGL_SURFACE_TYPE,
    EGL_SWAP_BEHAVIOR, EGL_TRUE, EGL_VERSION, EGL_VG_ALPHA_FORMAT_PRE_BIT, EGL_WIDTH,
    EGL_WINDOW_BIT, EGLBoolean, EGLConfig, EGLContext, EGLDisplay,
    EGLint, EGLNativeWindowType, EGLSurface,
};

use crate::{__log, console_log, LogPriority};
