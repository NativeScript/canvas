...
#[no_mangle]
pub extern "C" fn canvas_url_can_parse(value: *const c_char, base: *const c_char) -> bool {
...
#[no_mangle]
pub extern "C" fn canvas_url_create(value: *const c_char, base: *const c_char) -> *mut URL {
    let value = unsafe { CStr::from_ptr(value) };
    let value = value.to_string_lossy();
...
#[no_mangle]
pub extern "C" fn canvas_url_destroy(url: *mut URL) {
    if !url.is_null() {
...
#[no_mangle]
pub extern "C" fn canvas_url_to_string(url: *mut URL) -> *mut CCow {
    if url.is_null() {
    ...
    Box::into_raw(Box::new(CCow(Cow::from(url.to_string()))))
}

#[no_mangle]
pub extern "C" fn canvas_url_hash(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_set_hash(url: *mut URL, hash: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_host(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_set_host(url: *mut URL, host: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_host_name(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_set_host_name(url: *mut URL, hostname: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_href(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_set_href(url: *mut URL, href: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_origin(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_password(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_set_password(url: *mut URL, password: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_pathname(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_set_pathname(url: *mut URL, pathname: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_port(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_set_port(url: *mut URL, port: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_protocol(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_set_protocol(url: *mut URL, protocol: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_search(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_set_search(url: *mut URL, search: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_username(url: *mut URL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn canvas_url_set_username(url: *mut URL, username: *const c_char) {
    if url.is_null() {
        return;
    }
