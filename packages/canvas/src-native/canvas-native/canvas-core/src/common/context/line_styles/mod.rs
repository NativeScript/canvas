...
impl Context {
    ...
    pub fn set_line_cap(&mut self, cap: LineCap) {
        ...
        self.state.paint.stroke_paint_mut().set_stroke_cap(cap.into());
    }
    ...
    pub fn set_line_join(&mut self, join: LineJoin) {
        ...
        self.state.paint.stroke_paint_mut().set_stroke_join(join.into());
    }
    ...
    pub fn line_dash(&self) -> &[c_float] {
        self.state.line_dash_list.as_slice()
    }

    pub fn set_line_dash_offset(&mut self, offset: c_float) {
        self.state.line_dash_offset = offset;
        let dash = self.state.line_dash_list.to_vec();
        self.set_line_dash(dash.as_slice());
    }
