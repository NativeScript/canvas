...
#[allow(unused)]
pub(crate) fn flip_in_place(pixels: *mut u8, length: usize, bytes_per_row: usize, height: usize) {
...
pub(crate) fn bytes_per_pixel(pixel_type: u32, format: u32) -> u32 {
