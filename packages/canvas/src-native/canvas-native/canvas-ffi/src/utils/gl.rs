...
pub extern "C" fn flip_y_in_place(
    ...
    canvas_core::utils::gl::flip_in_place(data, length, bytes_per_row, height)
}
...
pub extern "C" fn flip_y_in_place_3d(
    ...
    canvas_core::utils::gl::flip_in_place_3d(data, length, bytes_per_row, height, depth)
}
...
pub extern "C" fn flip_y_in_place_i8(
    ...
    canvas_core::utils::gl::flip_in_place(data as *mut u8, length, bytes_per_row, height)
}
