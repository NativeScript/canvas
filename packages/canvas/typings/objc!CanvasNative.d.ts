...
declare class TNSSVG extends UIView {
	...
	static alloc(): TNSSVG; // inherited from NSObject

	static appearance(): TNSSVG; // inherited from UIAppearance

	static appearanceForTraitCollection(trait: UITraitCollection): TNSSVG; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedIn(trait: UITraitCollection, ContainerClass: typeof NSObject): TNSSVG; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): TNSSVG; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): TNSSVG; // inherited from UIAppearance
...
declare function svg_draw_from_path(context: number, path: interop.Pointer | interop.Reference<number>): void;

declare function svg_draw_from_string(context: number, svg: interop.Pointer | interop.Reference<number>): void;
