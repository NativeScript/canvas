...
// Resize
  ...
  createScene(engine) {
    ...
    setInterval(function () {
      ...
      materialBox2.diffuseColor = new BABYLON.Color3(
        Math.random(),
        Math.random(),
        Math.random()
      );
  ...
  createWaterScene(engine) {
    ...
    skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture(
      this.root + '/images/skybox/TropicalSunnyDay',
      scene
    );
    ...
    waterMaterial.bumpTexture = new BABYLON.Texture(
      this.root + '/images/waterbump.png',
      scene
    );
