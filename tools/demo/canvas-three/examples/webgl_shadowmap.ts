...
function createScene() {
	...
	loader.load(root + 'fonts/helvetiker_bold.typeface.json', function (font) {
	...
	gltfloader.load(root + 'models/gltf/Horse.glb', function (gltf) {
	...
	gltfloader.load(root + 'models/gltf/Flamingo.glb', function (gltf) {
		const mesh = gltf.scene.children[0];
		const clip = gltf.animations[0];
	...
	gltfloader.load(root + 'models/gltf/Stork.glb', function (gltf) {
		const mesh = gltf.scene.children[0];
		const clip = gltf.animations[0];
	...
	gltfloader.load(root + 'models/gltf/Parrot.glb', function (gltf) {
		const mesh = gltf.scene.children[0];
		const clip = gltf.animations[0];
