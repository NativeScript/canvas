...
var camera, fieldOfView, nearPlane, farPlane, HEIGHT, WIDTH, renderer, container, hemisphereLight, petalCore, canvas, context: GPUCanvasContext;
var scene: THREE.Scene;
var aspectRatio: number;

async function createScene(canvas: Canvas) {
...
export async function tiny_poly_world_webgpu(value) {
	canvas = value;
