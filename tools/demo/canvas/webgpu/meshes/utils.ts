import { vec3, Vec3 } from '../../../wgpu-matrix/wgpu-matrix';

export function computeSurfaceNormals(positions: [number, number, number][], triangles: [number, number, number][]): [number, number, number][] {
...
export function generateNormals(maxAngle: number, positions: [number, number, number][], triangles: [number, number, number][]) {
	...
	function getNewVertIndex(position: [number, number, number], normal: [number, number, number]) {
...
export function computeProjectedPlaneUVs(positions: [number, number, number][], projectedPlane: ProjectedPlane = 'xy'): [number, number][] {
